...
|--------|--------|----------|-------|-------|-------|
| Main (dashboard) | `develop` | repo root | Phase 3 ✅ + Phase 4 ✅; Phase 6 polish/perf — **waves 4-13: lazy loading (both WASM apps) + PWA (both apps) + 6.4/6.6/6.7/6.8 + chat infinite scroll (wave 11) + preload & a11y (wave 12) + render optimization (wave 13)** (dashboard bUnit 204/204, admin 158/158, E2E 18/18) | sess-main | active |
